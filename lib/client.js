...
class MegalodonClient {
    constructor(controller, settings, primary) {
        ...
        this.client.on("ready", async () => {
            ...
            if (this.primary) {
                ...
                (_c = this.client.guilds.resolve(this.controller.devguild)) === null || _c === void 0 ? void 0 : _c.commands.set(commands);
                (_d = this.client.application) === null || _d === void 0 ? void 0 : _d.commands.set(commands);
                this.client.on("interaction", async (interaction) => {
                    ...
                    if (interaction.isCommand() &&
                        ...
                        if (this.controller.auto.has(autoID)) {
                            ...
                            interaction.reply(`${this.controller.name} Disabled in <#${interaction.channelID}> for ${((_a = interaction.member) === null || _a === void 0 ? void 0 : _a.nick) || interaction.member.user.username}`, {
                                allowedMentions: { parse: [] },
                            });
                        }
                        else {
                            this.controller.auto.add(autoID);
                            interaction.reply(`${this.controller.name} Enabled in <#${interaction.channelID}> for ${((_b = interaction.member) === null || _b === void 0 ? void 0 : _b.nick) || interaction.member.user.username}`, {
                                allowedMentions: { parse: [] },
                            });
                            return;
                        }
                        ...
                        if (((_d = (_c = interaction.options) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.name) === "name") {
                            const name = (_e = interaction.options[0].options) === null || _e === void 0 ? void 0 : _e[0].value;
    ...
    async playSSML(ssml, channel, user, settings) {
        ...
        if (channel instanceof Discord.StageChannel) {
            await ((_b = connection.voice) === null || _b === void 0 ? void 0 : _b.setSuppressed(false));
        }
        if (response.audioContent) {
            ...
            if (channel.guild.id !== this.controller.devguild)
                (_c = channel.guild.me) === null || _c === void 0 ? void 0 : _c.setNickname(`${(_d = channel.guild.me.displayName) === null || _d === void 0 ? void 0 : _d.split(" | ")[0]} | ${(settings === null || settings === void 0 ? void 0 : settings.NAME) || ((_e = channel.guild.members.resolve(user.id)) === null || _e === void 0 ? void 0 : _e.displayName) || user.username}`.slice(0, 32));

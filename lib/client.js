...
class MegalodonClient {
    constructor(controller, settings, primary) {
        ...
        this.client.on("ready", async () => {
            ...
            embed.setAuthor({
                name: (_b = (_a = this.client.user) === null || _a === void 0 ? void 0 : _a.username) !== null && _b !== void 0 ? _b : "N/A",
                iconURL: ((_c = this.client.user) === null || _c === void 0 ? void 0 : _c.avatarURL()) || undefined
            });
    ...
    async disconnect() {
        ...
        const embed = new Discord.MessageEmbed();
        embed.setAuthor({
            name: (_a = this.client.user) === null || _a === void 0 ? void 0 : _a.username,
            iconURL: ((_b = this.client.user) === null || _b === void 0 ? void 0 : _b.avatarURL()) || undefined
        });
